export const metadata = {
  title: "Conditions d'utilisation — Primini.ma"
};
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm leading-relaxed text-slate-600">
        L&apos;utilisation de Primini.ma implique l&apos;acceptation des présentes conditions générales. Les prix et fiches
      ...
      <ul className="list-disc space-y-2 pl-6 text-sm text-slate-600">
        <li>Primini.ma ne vend pas de produits et redirige vers des marchands tiers.</li>
